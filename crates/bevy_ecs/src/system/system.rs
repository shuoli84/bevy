...
pub trait System: Send + Sync + 'static {
    ...
    /// Returns the system's component's [`Access`].
    fn component_access(&self) -> &Access<ComponentId>;

    /// Returns the system's ArchetypeComponent's [`Access`].
    ...
    /// apply buffers for the system. ([`Deferred`](`crate::system::Deferred`) doc for reference)
    ...
    /// Check the system's change tick. ([`CHECK_TICK_THRESHOLD`](`crate::change_detection::CHECK_TICK_THRESHOLD`) doc for reference)
